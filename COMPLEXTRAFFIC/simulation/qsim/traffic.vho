...
SIGNAL \A1|count~0_combout\ : std_logic;
...
SIGNAL \A2|next_state.ST3~0_combout\ : std_logic;
...
SIGNAL \A2|next_state.ST4~0_combout\ : std_logic;
...
SIGNAL \A2|WideOr3~0_combout\ : std_logic;
SIGNAL \A2|next_state.ST8~0_combout\ : std_logic;
SIGNAL \A2|Equal2~0_combout\ : std_logic;
...
SIGNAL \A2|ALT_INV_WideOr3~0_combout\ : std_logic;
...
\A2|ALT_INV_WideOr3~0_combout\ <= NOT \A2|WideOr3~0_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \A2|ALT_INV_WideOr3~0_combout\,
	devoe => ww_devoe,
	o => \LEDG[0]~output_o\);
...
-- Equation(s):
-- \A1|Equal0~7_combout\ = (!\A1|count\(7) & (!\A1|count\(6) & (!\A1|count\(5) & !\A1|count\(4))))
...
-- Equation(s):
-- \A1|Equal0~6_combout\ = (!\A1|count\(8) & (!\A1|count\(9) & (!\A1|count\(10) & !\A1|count\(11))))
...
-- Equation(s):
-- \A1|Equal0~8_combout\ = (\A1|count\(0) & (!\A1|count\(2) & (!\A1|count\(3) & !\A1|count\(1))))
...
-- Equation(s):
-- \A1|Equal0~5_combout\ = (!\A1|count\(13) & (!\A1|count\(14) & (!\A1|count\(15) & !\A1|count\(12))))
...
-- Equation(s):
-- \A1|Equal0~9_combout\ = (\A1|Equal0~7_combout\ & (\A1|Equal0~6_combout\ & (\A1|Equal0~8_combout\ & \A1|Equal0~5_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \A1|Equal0~7_combout\,
	datab => \A1|Equal0~6_combout\,
	datac => \A1|Equal0~8_combout\,
	datad => \A1|Equal0~5_combout\,
...
\A1|count~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \A1|count~0_combout\ = (\A1|Add0~2_combout\ & ((!\A1|Equal0~9_combout\) # (!\A1|Equal0~4_combout\)))
...
-- pragma translate_on
PORT MAP (
	datab => \A1|Equal0~4_combout\,
	datac => \A1|Equal0~9_combout\,
	datad => \A1|Add0~2_combout\,
	combout => \A1|count~0_combout\);
...
-- Equation(s):
-- \A1|Equal0~2_combout\ = (!\A1|count\(23) & (!\A1|count\(22) & (!\A1|count\(21) & !\A1|count\(20))))
...
-- Equation(s):
-- \A1|Equal0~1_combout\ = (!\A1|count\(24) & (!\A1|count\(26) & (!\A1|count\(27) & !\A1|count\(25))))
...
-- Equation(s):
-- \A1|Equal0~0_combout\ = (!\A1|count\(29) & (!\A1|count\(30) & (!\A1|count\(28) & !\A1|count\(31))))
...
-- Equation(s):
-- \A1|Equal0~4_combout\ = (\A1|Equal0~2_combout\ & (\A1|Equal0~1_combout\ & (\A1|Equal0~3_combout\ & \A1|Equal0~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \A1|Equal0~2_combout\,
	datab => \A1|Equal0~1_combout\,
	datac => \A1|Equal0~3_combout\,
	datad => \A1|Equal0~0_combout\,
...
-- Equation(s):
-- \A2|process_0~0_combout\ = (!\SW[3]~input_o\ & (!\SW[4]~input_o\ & (\SW[2]~input_o\ $ (!\SW[1]~input_o\))))
...
-- Equation(s):
-- \A2|next_state~35_combout\ = (!\SW[3]~input_o\ & (!\SW[4]~input_o\ & (\SW[2]~input_o\ $ (\SW[1]~input_o\))))
...
-- Equation(s):
-- \A2|Equal4~0_combout\ = (!\SW[3]~input_o\ & (!\SW[2]~input_o\ & (\SW[1]~input_o\ & !\SW[4]~input_o\)))
...
-- Equation(s):
-- \A2|next_state~33_combout\ = (!\SW[3]~input_o\ & (\SW[2]~input_o\ & (!\SW[1]~input_o\ & !\SW[4]~input_o\)))
...
-- Equation(s):
-- \A2|WideOr0~0_combout\ = (!\A2|next_state.ST5~q\ & (!\A2|next_state.ST4~q\ & !\A2|next_state.ST6~q\))
...
-- Equation(s):
-- \A2|next_state~47_combout\ = (\A2|next_state~33_combout\ & (!\A2|next_state.ST3~q\ & \A2|WideOr0~0_combout\))
...
\A2|next_state.ST3~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \A2|next_state.ST3~0_combout\ = (\A2|next_state~36_combout\ & (\A2|next_state~47_combout\)) # (!\A2|next_state~36_combout\ & ((\A2|next_state.ST3~q\)))
...
PORT MAP (
	...
	datac => \A2|next_state.ST3~q\,
	datad => \A2|next_state~36_combout\,
	combout => \A2|next_state.ST3~0_combout\);

-- Location: LCCOMB_X114_Y38_N0
\A2|next_state~31\ : cycloneive_lcell_comb
-- Equation(s):
-- \A2|next_state~31_combout\ = (\SW[2]~input_o\) # ((\SW[1]~input_o\) # (\SW[3]~input_o\ $ (!\SW[4]~input_o\)))
...
-- Equation(s):
-- \A2|next_state~38_combout\ = (\A2|process_0~0_combout\ & (\A2|next_state~31_combout\ & !\A2|next_state.ST0~q\))
...
-- Equation(s):
-- \A2|next_state~39_combout\ = (\A2|process_0~0_combout\ & (\A2|next_state~31_combout\ & \A2|next_state.ST1~q\))
...
PORT MAP (
	dataa => \A2|process_0~0_combout\,
	datab => \A2|next_state~31_combout\,
...
-- Equation(s):
-- \A2|next_state~48_combout\ = (\A2|next_state~31_combout\ & \A2|next_state.ST2~q\)
...
PORT MAP (
	clk => \A1|ALT_INV_temp~clkctrl_outclk\,
	d => \A2|next_state.ST3~0_combout\,
	asdata => \A2|next_state~48_combout\,
	sload => \A2|process_0~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \A2|next_state~30_combout\ = (\A2|next_state.ST0~q\ & (!\A2|next_state.ST3~q\ & (!\A2|next_state.ST2~q\ & !\A2|next_state.ST1~q\)))
...
-- Equation(s):
-- \A2|next_state~42_combout\ = (\A2|next_state~33_combout\ & \A2|next_state.ST3~q\)
...
-- pragma translate_on
PORT MAP (
	datab => \A2|next_state~33_combout\,
	datad => \A2|next_state.ST3~q\,
	combout => \A2|next_state~42_combout\);

-- Location: LCCOMB_X113_Y38_N8
\A2|next_state.ST4~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \A2|next_state.ST4~0_combout\ = (\A2|Equal4~0_combout\ & (!\A2|next_state~30_combout\)) # (!\A2|Equal4~0_combout\ & ((\A2|next_state~42_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \A2|Equal4~0_combout\,
	datab => \A2|next_state~30_combout\,
	datad => \A2|next_state~42_combout\,
	combout => \A2|next_state.ST4~0_combout\);

-- Location: LCCOMB_X114_Y38_N12
\A2|next_state~43\ : cycloneive_lcell_comb
-- Equation(s):
-- \A2|next_state~43_combout\ = (\A2|next_state~31_combout\ & \A2|next_state.ST3~q\)
...
PORT MAP (
	clk => \A1|ALT_INV_temp~clkctrl_outclk\,
	d => \A2|next_state.ST4~0_combout\,
	asdata => \A2|next_state~43_combout\,
	sload => \A2|process_0~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \A2|next_state~41_combout\ = (\A2|process_0~0_combout\ & (\A2|next_state.ST4~q\)) # (!\A2|process_0~0_combout\ & (((\A2|next_state.ST5~q\ & !\A2|next_state~36_combout\))))
...
-- Equation(s):
-- \A2|next_state~40_combout\ = (\A2|process_0~0_combout\ & (\A2|next_state.ST5~q\)) # (!\A2|process_0~0_combout\ & (((\A2|next_state.ST6~q\ & !\A2|next_state~36_combout\))))
...
-- Equation(s):
-- \A2|next_state~45_combout\ = (\A2|next_state.ST6~q\ & ((\SW[1]~input_o\) # (!\SW[2]~input_o\)))
...
-- Equation(s):
-- \A2|next_state~44_combout\ = (\SW[1]~input_o\ & (!\SW[2]~input_o\ & ((\A2|next_state.ST5~q\) # (\A2|next_state.ST4~q\))))
...
-- Equation(s):
-- \A2|next_state~46_combout\ = (!\SW[3]~input_o\ & (!\SW[4]~input_o\ & ((\A2|next_state~45_combout\) # (\A2|next_state~44_combout\))))
...
PORT MAP (
	dataa => \SW[3]~input_o\,
	datab => \SW[4]~input_o\,
	datac => \A2|next_state~45_combout\,
	datad => \A2|next_state~44_combout\,
...
-- Equation(s):
-- \A2|next_state~36_combout\ = ((\A2|next_state.ST7~q\) # ((!\A2|WideOr0~0_combout\) # (!\A2|next_state~30_combout\))) # (!\A2|next_state~35_combout\)
...
-- pragma translate_on
PORT MAP (
	dataa => \A2|next_state~35_combout\,
	datab => \A2|next_state.ST7~q\,
	datac => \A2|next_state~30_combout\,
	datad => \A2|WideOr0~0_combout\,
...
-- Equation(s):
-- \A2|next_state~32_combout\ = (\A2|next_state~31_combout\ & (\A2|process_0~0_combout\ & \A2|next_state.ST7~q\))
...
PORT MAP (
	...
	datad => \A2|next_state.ST7~q\,
	combout => \A2|next_state~32_combout\);

-- Location: LCCOMB_X113_Y38_N6
\A2|next_state~34\ : cycloneive_lcell_comb
-- Equation(s):
-- \A2|next_state~34_combout\ = (\A2|WideOr0~0_combout\ & (\A2|Equal4~0_combout\ & ((\A2|next_state~30_combout\)))) # (!\A2|WideOr0~0_combout\ & (((\A2|next_state~33_combout\))))
...
-- Equation(s):
-- \A2|next_state~37_combout\ = (!\A2|next_state~32_combout\ & ((\A2|process_0~0_combout\) # ((!\A2|next_state~34_combout\) # (!\A2|next_state~36_combout\))))
...
PORT MAP (
	dataa => \A2|process_0~0_combout\,
	datab => \A2|next_state~36_combout\,
	datac => \A2|next_state~32_combout\,
	datad => \A2|next_state~34_combout\,
...
\A2|WideOr3~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \A2|WideOr3~0_combout\ = (\A2|next_state.ST0~q\ & (!\A2|next_state.ST1~q\ & !\A2|next_state.ST2~q\))
...
PORT MAP (
	...
	combout => \A2|WideOr3~0_combout\);

-- Location: LCCOMB_X113_Y38_N0
\A2|next_state.ST8~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \A2|next_state.ST8~0_combout\ = (\A2|next_state~36_combout\ & (!\A2|next_state~35_combout\)) # (!\A2|next_state~36_combout\ & ((\A2|next_state.ST8~q\)))
...
PORT MAP (
	dataa => \A2|next_state~35_combout\,
	datac => \A2|next_state.ST8~q\,
	datad => \A2|next_state~36_combout\,
	combout => \A2|next_state.ST8~0_combout\);

-- Location: LCCOMB_X114_Y38_N10
\A2|Equal2~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \A2|Equal2~0_combout\ = (!\SW[2]~input_o\ & !\SW[1]~input_o\)
...
PORT MAP (
	datab => \SW[2]~input_o\,
	datac => \SW[1]~input_o\,
	combout => \A2|Equal2~0_combout\);

-- Location: LCCOMB_X113_Y38_N22
\A2|next_state~50\ : cycloneive_lcell_comb
-- Equation(s):
-- \A2|next_state~50_combout\ = (\SW[3]~input_o\ & (\A2|next_state.ST9~q\ & ((\SW[4]~input_o\) # (!\A2|Equal2~0_combout\)))) # (!\SW[3]~input_o\ & ((\A2|next_state.ST9~q\) # ((\SW[4]~input_o\ & \A2|Equal2~0_combout\))))
...
PORT MAP (
	dataa => \SW[3]~input_o\,
	datab => \SW[4]~input_o\,
	datac => \A2|Equal2~0_combout\,
	datad => \A2|next_state.ST9~q\,
...
PORT MAP (
	clk => \A1|ALT_INV_temp~clkctrl_outclk\,
	d => \A2|next_state.ST8~0_combout\,
	asdata => \A2|next_state~50_combout\,
	sload => \A2|process_0~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \A2|next_state~49_combout\ = (\A2|process_0~0_combout\ & (\A2|next_state.ST8~q\)) # (!\A2|process_0~0_combout\ & (((\A2|next_state.ST9~q\ & !\A2|next_state~36_combout\))))
...
-- Equation(s):
-- \A2|WideOr1~combout\ = (\A2|next_state.ST9~q\) # (!\A2|next_state~30_combout\)
...
-- Equation(s):
-- \A2|WideOr0~combout\ = (\A2|next_state.ST9~q\) # ((\A2|next_state.ST7~q\) # (!\A2|WideOr0~0_combout\))
